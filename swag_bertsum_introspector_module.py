...
from models import SwagIntrospector, BertSumIntrospector
from buffer import buffer_collate_for_intro, buffer_collate_for_bertsumintro


class BertSumIntrospectorModule(pl.LightningModule):
    def __init__(self, config):
        super(BertSumIntrospectorModule, self).__init__()
        self.config = config
        self.save_hyperparameters()
        self.tokenizer = BertTokenizer.from_pretrained(config.model_name)
        self.introspector = BertSumIntrospector.from_pretrained(config.model_name, intro_config=config)
    ...
    def train_dataloader(self):
        ...
        loader = DataLoader(
            ...
            collate_fn=buffer_collate_for_bertsumintro,
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_introspector, logits = self.introspector(*inputs, labels_list, clses_list, mask_cls)
